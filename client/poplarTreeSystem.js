...
class PoplarTreeSystem {
    constructor(scene, terrainSystem = null) {
        ...
        this._textureAspect = 1.0;
        this.treeTexture = new THREE.TextureLoader().load('../Images/tree.png', (tex) => {
            if (tex.image) {
                this._textureAspect = (tex.image.width / tex.image.height) || 1.0;
            }
        });
    ...
    addTree(worldX, worldZ, terrainHeight, metadata = {}) {
        ...
        const textureAspect = this._textureAspect || 1.0;
        const planeWidth = 2.2;
        const planeHeight = 2.6;
        const targetWidth = planeHeight * textureAspect;
