...
function getDirections(moveType) {
    switch (moveType) {
        case 'straight':
            return [
                { dx: 0, dz: 1 }, { dx: 0, dz: -1 },
...
class MoveValidator {
    constructor() {
        ...
        this.movePatterns = MOVEMENT_PATTERNS;
    }

    static get PATTERNS() { return MOVEMENT_PATTERNS; }
    static getDirections(moveType) { return getDirections(moveType); }
