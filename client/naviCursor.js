(function () {
    ...
    class NaviCursor {
        ...
        bindEvents() {
            ...
            window.addEventListener('blur', this.onMouseLeave, { passive: true });
        ...
        handleMouseMove(event) {
            ...
            const isInteractive = target ? Boolean(target.closest(INTERACTIVE_SELECTORS)) : false;
        ...
        updateDrowning() {
            ...
            switch (this.drowningState) {
                ...
                case 'underwater': {
                    ...
                    if (elapsed >= durUnder) {
                        // console.log('[NaviCursor] Drowning → emerging');
